...
function ProgressBar({ currentStep }: {
    ...
    return (<nav aria-label="Wizard progress" className="mb-8">
            ...
            return (<React.Fragment key={step.number}>
              <li className="flex flex-col items-center gap-1.5">
                <div className={[
                  ...
                  {isCompleted ? (<svg className="h-4 w-4" fill="none" viewBox="0 0 24 24" strokeWidth={2.5} stroke="currentColor" aria-hidden="true">
              ...
              {!isLast && (<div aria-hidden="true" className={[
...
export default function CreateAssignmentPage() {
    ...
    return (<div className="mx-auto w-full max-w-2xl px-4 py-8">
      ...
      <div className="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm">
        {currentStep === 1 ? (<Step1Details onNext={handleNext}/>) : (<Step2Settings onPrevious={handlePrevious}/>)}
      </div>
    </div>);
}
