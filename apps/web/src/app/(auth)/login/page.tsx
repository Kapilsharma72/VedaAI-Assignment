      ...
      <div className="w-full max-w-md bg-white rounded-[0.75rem] shadow-md p-8">
        ...
        <form onSubmit={handleSubmit(onSubmit)} noValidate className="space-y-5">
          ...
          <div>
            ...
            <input id="password" type="password" autoComplete="current-password" {...register('password')} className={`w-full rounded-lg border px-3 py-2.5 text-sm text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-[#6366f1] transition ${errors.password ? 'border-red-500 focus:ring-red-400' : 'border-gray-300'}`} placeholder="••••••••"/>
