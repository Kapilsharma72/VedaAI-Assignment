...
function validateBody(schema: Joi.ObjectSchema, data: unknown, res: Response): boolean {
...
router.post('/register', async (req: Request, res: Response, next: NextFunction): Promise<void> => {
    if (!validateBody(registerSchema, req.body, res))
        return;
    try {
...
router.post('/login', async (req: Request, res: Response, next: NextFunction): Promise<void> => {
    if (!validateBody(loginSchema, req.body, res))
        return;
    try {
